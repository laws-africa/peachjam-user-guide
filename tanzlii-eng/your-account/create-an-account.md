---
description: Create an account on TanzLII to save documents, set alerts, and follow topics.
---
...
Because TanzLII uses an email-based code to log you in, a password is not strictly required. However, if you prefer to sign up with a password:
...
[log-in]: https://tanzlii.org/accounts/login/